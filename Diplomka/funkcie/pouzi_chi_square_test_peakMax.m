...
function [chi2_stat_array, p_value_array, critical_value_array] = pouzi_chi_square_test_peakMax(cely_tok, gen_sampled, posun_dat, shift, pocet_tried_hist, chi_alfa, use_fourier, keep_frequencies,simul_folder_path)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        if k == 2
            ...
            histogram(gen_sampled,pocet_tried_hist);
            [h] = hist(gen_sampled,pocet_tried_hist);
            title(sprintf('Hist generated od %d do %d',1,posun_dat));
            xlabel("Triedy")
            ylabel("Počet paketov");
    
            saveas(figure16,fullfile(simul_folder_path,sprintf('lHist generated od %d do %d.fig',1,posun_dat)));
            saveas(figure16,fullfile(simul_folder_path,sprintf('lHist generated od %d do %d.png',1,posun_dat)));
        end
