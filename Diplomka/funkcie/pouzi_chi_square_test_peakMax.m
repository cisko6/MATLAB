...
function [chi2_stat_array, p_value_array, critical_value_array] = pouzi_chi_square_test_peakMax(cely_tok, gen_sampled, compute_window, shift, pocet_tried_hist, chi_alfa, use_fourier, keep_frequencies,simul_folder_path)
