...
function [statistika_array, dolne_hranice, horne_hranice, index_H] = vytvor_autonomny_tunel1(cely_tok, compute_window,predict_window,typ_peaku,typ_statistiky,simulacia,chi_alfa,pocet_tried_hist,sigma_nasobok,average_multiplier,fileID,use_fourier,keep_frequencies)
    ...
    statistika_array = statistika_array(1:length(horne_hranice)+predict_window);
    fprintf(fileID,'\n\n');
end
