...
for j=2:8
    ...
    for l=1:3
        ...
        tunel_folder_name = folder_name + "\" + num2str(compute_window) + " cw\";
        ...
        for r=1:4
            ...
            [statistika_array, dolne_hranice, horne_hranice, index_H] = vytvor_lenivy_tunel(cely_tok,gen_prve_cw, compute_window,predict_window,typ_statistiky,chi_alfa,pocet_tried_hist,sigma_nasobok);

            figtunel = figure('Visible', 'off');
            N = length(statistika_array);
            ...
            plot(t3,0,t,statistika_array,'b',t2,dolne_hranice,'r',t2,horne_hranice,'r')
