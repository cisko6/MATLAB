    ...
    for l=1:3
        ...
        for o=1:3
            ...
            for r=1:4
                ...
                [chi2stat_array, dolne_hranice, horne_hranice, index_H] = vytvor_lenivy_tunel(cely_tok,gen_prve_cw, compute_window,predict_window,typ_statistiky,chi_alfa,pocet_tried_hist,sigma_nasobok);
