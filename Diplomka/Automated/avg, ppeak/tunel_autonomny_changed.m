...
typ_peaku = "changed"; % changed only here
keep_frequencies = 3;
slot_window = 0.01;
predict_window = 1000;
...
for j=9:12
    ...
    for l=1:2
        ...
        for o=3:3
            ...
            fprintf(fileID, 'AVERAGE_MULTIPLIER = %d\n', average_multiplier);
            ...
            for r=2:3
                ...
                saveas(figtunel,fullfile(average_folder_path,sprintf('TUNEL, sigma=%d ,compute_window=%d, predict_window=%d.fig',sigma_nasobok,compute_window,predict_window)));
                saveas(figtunel,fullfile(average_folder_path,sprintf('TUNEL, sigma=%d , compute_window=%d, predict_window=%d.png',sigma_nasobok,compute_window,predict_window)));
                close(figtunel)
            end
        end
        ...
        clearvars -except M slot_window predict_window fileID file_path attack_name sigma_nasobok folder_path where_to_store attacks_folder_mat folder_name compute_window typ_statistiky typ_peaku shift pocet_tried_hist chi_alfa simulacia use_fourier keep_frequencies cely_tok;    
        close all;
    end
    fclose(fileID);
end
