...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        saveas(figure13,fullfile(simul_folder_path,sprintf('p_Hist %s od %d do %d.fig', simulacia,1,compute_window)));
        saveas(figure13,fullfile(simul_folder_path,sprintf('p_Hist %s od %d do %d.png', simulacia,1,compute_window)));
        close(figure13)
        ...
        % save data
        saveas(figure1,fullfile(folder_path,sprintf('DATA, compute_window=%d, chi_alfa=%.2f, pocet_tried_hist=%d, shift=%d.fig',compute_window,chi_alfa,pocet_tried_hist, shift)));
        saveas(figure1,fullfile(folder_path,sprintf('DATA, compute_window=%d, chi_alfa=%.2f, pocet_tried_hist=%d, shift=%d.png',compute_window,chi_alfa,pocet_tried_hist, shift)));
        close(figure1)

        saveas(figure2,fullfile(folder_path,sprintf('CHI2STAT_CRITICVALUE, compute_window=%d, chi_alfa=%.2f, pocet_tried_hist=%d, shift=%d.fig',compute_window,chi_alfa,pocet_tried_hist, shift)));
        saveas(figure2,fullfile(folder_path,sprintf('CHI2STAT_CRITICVALUE, compute_window=%d, chi_alfa=%.2f, pocet_tried_hist=%d, shift=%d.png',compute_window,chi_alfa,pocet_tried_hist, shift)));
        close(figure2)

        saveas(figure3,fullfile(folder_path,sprintf('PVALUE_CHIALFA, compute_window=%d, chi_alfa=%.2f, pocet_tried_hist=%d, shift=%d.fig',compute_window,chi_alfa,pocet_tried_hist, shift)));
        saveas(figure3,fullfile(folder_path,sprintf('PVALUE_CHIALFA, compute_window=%d, chi_alfa=%.2f, pocet_tried_hist=%d, shift=%d.png',compute_window,chi_alfa,pocet_tried_hist, shift)));
        close(figure3)
